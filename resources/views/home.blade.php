<x-main-layout>
    ...
    <section id="home" class="bg-cover bg-center antialiased pt-32">
        <div class="py-24 px-4 mx-auto max-w-screen-xl lg:px-0">
            <h1 class="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-50 md:text-4xl lg:text-5xl">Event Terbaru Menunggumu.</h1>
            <p class="max-w-4xl mb-8 text-mds font-normal text-gray-50 lg:text-xl">Jelajahi dan cari event yang kamu suka, datangi, dan rasakan keseruan yang belum pernah ada sebelumnya.</p>
    ...
    <section class="bg-gray-50 py-8 antialiased md:py-12">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-4 items-end justify-center space-y-4 sm:flex sm:space-y-0 md:mb-8">
                <div>
                    <h2 class="mt-3 text-xl font-semibold text-gray-900 sm:text-2xl">Populer Baru-Baru Ini</h2>
                </div>
            </div>
    ...
    <section class="px-4 lg:px-0">
        <div id="carousel-container" class="relative w-full max-w-screen-xl mx-auto my-10 overflow-hidden rounded-lg shadow-xl">
            <div id="carousel-wrapper" class="flex transition-transform h-96 duration-500 ease-in-out">
              <div class="w-full flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=1740&auto=format&fit=crop" alt="Slide 1" class="w-full h-full object-cover">
              </div>
              <div class="w-full flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=1742&auto=format&fit=crop" alt="Slide 2" class="w-full h-full object-cover">
              </div>
              <div class="w-full flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1740&auto=format&fit=crop" alt="Slide 3" class="w-full h-full object-cover">
              </div>
            </div>
          
            <button id="prev-btn" class="absolute top-1/2 left-4 -translate-y-1/2 bg-white/60 hover:bg-white rounded-full p-2 transition-colors duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <button id="next-btn" class="absolute top-1/2 right-4 -translate-y-1/2 bg-white/60 hover:bg-white rounded-full p-2 transition-colors duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="bg-white">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 class="mb-8 lg:mb-16 text-3xl font-bold tracking-tight leading-tight text-center text-gray-900 md:text-4xl">Terima Kasih Kepada Partner</h2>
