<footer class="p-4 bg-[#102041] sm:p-6">
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between mt-8">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com" class="flex items-center">
                    <span class="self-center text-2xl font-semibold text-white whitespace-nowrap">Ticket-Ink</span>
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center">© 2025 <a href="https://flowbite.com" class="hover:underline">Ticket-Ink™</a>. All Rights Reserved.
            </span>
