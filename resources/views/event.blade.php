            ...
            <div class="relative overflow-hidden bg-white shadow-md sm:rounded-lg">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{{ $event->pembelians_count ?? 0 }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500">
                        Showing
                        <span class="font-semibold text-gray-900 ">{{ $events->firstItem() }}-{{ $events->lastItem() }}</span>
                        of
                        <span class="font-semibold text-gray-900 ">{{ $events->total() }}</span>
                    </span>
                    {{ $events->links() }} {{-- Ini akan merender link pagination default Laravel --}}
                </nav>
                @endif
            </div>
